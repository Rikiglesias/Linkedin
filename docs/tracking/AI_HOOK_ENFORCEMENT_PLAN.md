...
| `PostToolUse Bash`                       | `post-bash-handoff-invalidate.ps1`| async audit         | attivo                        | Invalida l'handoff/continuation quando un comando ne cambia i presupposti (git/test/stato).                                                                                                             |
