...
// VISUAL_CURSOR_* ora usati solo dal modulo cursorOverlay; qui restano gli INPUT_BLOCK_* (inputBlock).
import {
...
// → i caller non cambiano import. syncVisualCursorOverlay importata per uso interno (humanTap/humanSwipe).
import {
    ensureVisualCursorOverlay,
    syncVisualCursorOverlay,
