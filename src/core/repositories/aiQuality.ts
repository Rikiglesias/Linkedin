...
const DEFAULT_AI_VALIDATION_SAMPLES: SeedSample[] = [
    ...
    },
    {
        ...
        expected: { intent: 'POSITIVE', subIntent: 'REFERRAL', minConfidence: 0.5 },
    ...
    },
    {
        ...
        expected: { intent: 'POSITIVE', subIntent: 'NONE', minConfidence: 0.5 },
    ...
    },
    {
        ...
        expected: { intent: 'QUESTIONS', subIntent: 'NONE', minConfidence: 0.5 },
        tags: ['questions', 'en'],
    },
    {
        taskType: 'sentiment',
    ...
    },
    {
        ...
        expected: { intent: 'QUESTIONS', subIntent: 'NONE', minConfidence: 0.4 },
    ...
    // ── Sentiment: NEGATIVE / NOT_INTERESTED (5 campioni) ──
    {
        ...
        expected: { intent: 'NOT_INTERESTED', subIntent: 'NONE', minConfidence: 0.6 },
    ...
    },
    {
        ...
        expected: { intent: 'NEGATIVE', subIntent: 'NONE', minConfidence: 0.7 },
    ...
    },
    {
        ...
        expected: { intent: 'NEGATIVE', subIntent: 'OBJECTION_HANDLING', minConfidence: 0.5 },
    ...
    },
    {
        ...
        expected: { intent: 'NOT_INTERESTED', subIntent: 'NONE', minConfidence: 0.5 },
