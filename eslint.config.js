        ...
        rules: {
            ...
            'no-restricted-syntax': [
                'error',
                {
                    ...
                    message:
                        'fetch() richiede un secondo argomento con signal (AbortController o AbortSignal.timeout). I/O di rete senza timeout viola L3.3 (timeout esplicito su ogni I/O).',
                },
            ],
        },
    },
